...
if selected == options[0]:
    ...
    if submit:
        ...
        institute_logo_path = "../assets/image-removebg-preview.png"
        ...
        # Display Certificate ID with Copy Button
        st.success("Certificate successfully generated!")
        st.write("### Certificate ID:")
        st.code(certificate_id, language="plaintext")
...
# Home button using Streamlit (for better compatibility)
